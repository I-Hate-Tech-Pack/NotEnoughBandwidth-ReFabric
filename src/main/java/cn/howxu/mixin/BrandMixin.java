...
public abstract class BrandMixin extends Screen {
    ...
    private void onRender(DrawContext context, int mouseX, int mouseY, float deltaTicks, CallbackInfo ci, float f) {
        ...
        String brand_info = "Performance enhanced for " + SharedConstants.getGameVersion().getName() + " by howxu";
        context.drawTextWithShadow(this.textRenderer, brand_info, 2, this.height - 20,
                ColorHelper.Argb.getArgb(alpha, 0, 255, 0));
    }
}